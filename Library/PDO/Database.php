...
use Library\PDO\Statement\SelectStatement;
use Library\PDO\Statement\InsertStatement;
use Library\PDO\Statement\UpdateStatement;
use Library\PDO\Statement\DeleteStatement;
...
class Database extends \PDO
{
    ...
    protected function getDefaultOptions()
    {
        return array(
            ...
            \PDO::ATTR_STATEMENT_CLASS => array('Library\\PDO\\Statement', array($this)),
        );
    }
