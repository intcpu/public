...
namespace Library\PDO\Statement;

use Library\PDO\Clause\LimitClause;
use Library\PDO\Clause\OrderClause;
use Library\PDO\Clause\WhereClause;
...
abstract class StatementContainer
{
    ...
    protected function setPlaceholders(array $values)
    {
        foreach ($values as $value) {
            $this->placeholders[] = $this->setPlaceholder('?', is_array($value) ? sizeof($value) : 1 );
        }
    }
